...
extern "C++"
{
    ...
    namespace Apostol
    {
        ...
        namespace ChargePoint
        {
            ...
            COCPPMessageHandler::COCPPMessageHandler(COCPPMessageHandlerManager *AManager, const CJSONMessage &Message, COnMessageHandlerEvent &&Handler) : CCollectionItem(AManager), m_Handler(Handler)
            {
                m_Message = Message;
            }
            //--------------------------------------------------------------------------------------------------------------
            ...
            CCSChargingPoint::CCSChargingPoint(CCSChargingPointManager *AManager, CWebSocketConnection *AConnection) : CCollectionItem(AManager), CCustomChargingPoint(AConnection)
            {
            }
            //--------------------------------------------------------------------------------------------------------------
