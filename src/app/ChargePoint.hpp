...
extern "C++"
{
    ...
    namespace Apostol
    {
        ...
        namespace ChargePoint
        {
            ...
            enum CMessageTrigger
            {
                mtBootNotification = 0,
                mtDiagnosticsStatusNotification,
                mtFirmwareStatusNotification,
                mtHeartbeat,
                mtMeterValues,
                mtStatusNotification
            };

            enum CAuthorizationStatus
            {
                asAccepted = 0,
                asBlocked,
                asExpired,
            ...
            enum CRemoteStartStopStatus
            {
                rssAccepted = 0,
                rssRejected
            };

            enum CReservationStatus
            {
                rvsAccepted = 0,
                rvsFaulted,
                rvsOccupied,
            ...
            enum CCancelReservationStatus
            {
                crsAccepted = 0,
                crsRejected
            };

            enum CClearCacheStatus
            {
                ccsAccepted = 0,
                ccsRejected
            };

            enum CChargePointStatus
            {
                cpsAvailable = 0,
                cpsPreparing,
                cpsCharging,
            ...
            enum CChargePointErrorCode
            {
                cpeConnectorLockFailure = 0,
                cpeHighTemperature,
                cpeMode3Error,
                cpeNoError,
                cpePowerMeterFailure,
                cpePowerSwitchFailure,
                cpeReaderFailure,
                cpeResetFailure,
                cpeGroundFailure,
                cpeOverCurrentFailure,
                cpeUnderVoltage,
                cpeWeakSignal,
                cpeOtherError
            };
            ...
            enum CChargingVoltage
            {
                cvUnknown = -1,
                cvAC,
                cvDC
            };
            enum CChargingInterface
            {
                ciUnknown = -1,
                ciSchuko,
                ciType1,
